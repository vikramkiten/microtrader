...
DOCKER_REGISTRY ?= 109425528128.dkr.ecr.ap-south-1.amazonaws.com
AWS_ACCOUNT_ID ?= 109425528128
DOCKER_LOGIN_EXPRESSION := aws ecr get-login --registry-ids 109425528128 | sed 's/-e//'
# Release settings
